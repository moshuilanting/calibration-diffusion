...
model_name = '1006_0911_Franka_Random_Bottle_diffusion_sample_300_1200.pth'
print(model_name)
...
stable_infomation ={"location_pos": [[0.24802088008517637, 0.65, 0.4], 
                                     [0.29948354888091827, 0.65, 0.4], 
                                     [0.25124472707024337, 0.65, 0.4]],
                    "n": [3,1,0],
                    "obj_m": [4,3,3],
                    "start_pos": [[0.14476850236525676, 0.65, 0.6],
                                  [0.01032107216269379, 0.65, 0.6],
                                  [0.12611886008119813, 0.65, 0.6]],
                    "remove_m": [2,2,2],
                    "Camera": []}

camera_info = [[-0.8, -1.1, 2.0], [-0.4, -1.1, 2.0], [0.6, -1.1, 2.0], [-0.6, -0.9, 2.0],
                [0.6, -0.9, 2.0],[0.8, -0.9, 2.0],[-0.8, -0.9, 2.3], [-0.6, -0.9, 2.3],
                [-0.4, -0.9, 2.3], [0.8, -0.9, 2.3]]


if __name__=="__main__":  
    usd_home = '/home/jtl/ISAAC/cross_perspective_robotics_manipulation/calibration-diffusion/objects/usd/'
    ...
    while simulation_app.is_running():
        ...
        for t in range(50):
            ...
            location_pos = [random.uniform(0.15, 0.3), 0.65, 0.4]
            ...
            # print("remove_m: ",remove_m)

            # location_pos = stable_infomation["location_pos"][t%3]
            # n = stable_infomation["n"][t%3]
            # obj_m = stable_infomation["obj_m"][t%3]
            # start_pos = stable_infomation["start_pos"][t%3]
            # remove_m = stable_infomation["remove_m"][t%3]

            #camera_x,camera_y,camera_z = camera_info[t%10]
            ...
            gif_image[0].save('diffusion_arrange_bottle_{:d}.gif'.format(t),
               save_all=True,
