...
def diffusion_action_generation(count, image, depth, status, Base2Cam_RT, policy, seq_data, seq_length, Trans_Noise):
    ...
    #Trans_Noise = np.random.normal(loc=0.0, scale=0.05, size=Trans_Center.shape)
...
model_name = '/home/jtl/ISAAC/cross_perspective_robotics_manipulation/Calibration_Diffusion/0727_noise_0.1_0430_Franka_Classify_Fruits_Y_0.5_control_2_diffusion_finetune_sample_300_200.pth'
print(model_name)
#policy.load_state_dict(torch.load('hunder_diffusion_pull_1000.pth', map_location=device,weights_only=True))
policy.load_state_dict(torch.load(model_name, map_location=device,weights_only=False))
...
if __name__=="__main__":  
    ...
    while simulation_app.is_running():
        ...
        for t in range(50):
            ...
            #camera_x, camera_y, camera_z = 1.8 , 0.0,  1.6     
            ...
            #camera_rotato = [0,math.pi/4,math.pi]
            ...
            jump = 0
            effort = False
            Trans_Noise = np.random.normal(loc=0.0, scale=0.1, size=(9,))
            ...
            gif_image[0].save('control_diffusion_classify_fruits_{:d}.gif'.format(t),
               save_all=True,
