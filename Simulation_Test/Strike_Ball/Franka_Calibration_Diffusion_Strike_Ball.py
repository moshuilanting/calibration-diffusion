...
model_name = "Eplison_DDPM_0425_Franka_Strike_Ball_control_2_diffusion_finetune_sample_100_200.pth"
print(model_name)
...
if __name__=="__main__":
    ...
    while simulation_app.is_running():
        ...
        for t in range(50):
            ...
            gif_image[0].save('control_diffusion_strike_ball_{:d}.gif'.format(t),
               save_all=True,
