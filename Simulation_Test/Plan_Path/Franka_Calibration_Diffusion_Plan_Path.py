...
policy.eval()
policy.to(device)
model_name = "0410_Franka_Plan_Path_control_diffusion_finetune_sample_300_800.pth"
print(model_name)
...
if __name__=="__main__":  
    ...
    while simulation_app.is_running():
        ...
        for t in range(50):
            ...
            #机械臂回初始位置
            franka.set_joint_positions(np.array([0.23169483,  0.5348021,   0.26620936, -1.6795475,  -0.16399851,  2.1930306, 1.3452059, 0.0, 0.0]))
            ...
            gif_image[0].save('control_diffusion_plan_path_{:d}.gif'.format(t),
               save_all=True,
