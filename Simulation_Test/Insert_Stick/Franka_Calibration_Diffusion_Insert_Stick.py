...
model_name = "0410_Franka_Insert_Stick_control_2_diffusion_finetune_sample_300_400.pth"
print(model_name)
...
if __name__=="__main__":
    ...
    while simulation_app.is_running():
        ...
        for t in range(400):
            ...
            left_square_size = [0.4, 0.17, 0.02] 
            right_square_size = [0.4, 0.17, 0.02] 
            ...
            gif_image[0].save('control_diffusion_insert_stick_{:d}.gif'.format(t),
               save_all=True,
